...
def loadData_and_scalling():
    ...
    train_store_data = pd.read_csv(dataset_path+'train.csv')
    train_data = pd.read_csv(dataset_path+'train2.csv')
    test_store_data = pd.read_csv(dataset_path+'test.csv')
    df = pd.DataFrame()
